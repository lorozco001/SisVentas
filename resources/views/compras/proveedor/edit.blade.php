  	...
  	<div class="row">
			...
			<div class="form-group">
				...
				<select name="tipo_documento" class="form-control">
					@if ($persona->tipo_documento=="INE")
						<option value="">Elige tú Documento</option>
						<option value="INE" selected>INE</option>
						<option value="LIC">LIC</option>
						<option value="PAS">PAS</option>
					@elseif ($persona->tipo_documento=="LIC")
						<option value="">Elige tú Documento</option>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
		       	...
		       	<input type="text" name="telefono" required value="{{$persona->telefono}}" class="form-control" placeholder="Télefono...">
		    </div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
